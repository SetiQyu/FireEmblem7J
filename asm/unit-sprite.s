...
sub_08025114: @ 0x08025114
	ldr r1, _08025120 @ =0x0203A3CC
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	bx lr
	.align 2, 0
_08025120: .4byte 0x0203A3CC

	thumb_func_start ApplyUnitSpritePalettes
ApplyUnitSpritePalettes: @ 0x08025124
	push {lr}
	ldr r0, _0802514C @ =0x081900E8
	movs r1, #0xe0
	lsls r1, r1, #2
	movs r2, #0x80
	bl ApplyPaletteExt
...
_08025150: .4byte 0x0202BBB4
_08025154: .4byte 0x08190168
_08025158:
	ldr r0, _08025168 @ =0x08190188
	movs r1, #0xd8
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
_08025164:
	...
	bx r0
	.align 2, 0
_08025168: .4byte 0x08190188

	thumb_func_start sub_0802516C
sub_0802516C: @ 0x0802516C
	push {lr}
	ldr r0, _08025180 @ =0x081901A8
	movs r1, #0xf0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
	...
	bx r0
	.align 2, 0
_08025180: .4byte 0x081901A8

	thumb_func_start sub_08025184
sub_08025184: @ 0x08025184
	push {r4, r5, r6, lr}
	movs r2, #0xcf
	ldr r5, _080251AC @ =0x02039F14
	ldr r6, _080251B0 @ =0x02039F10
	ldr r4, _080251B4 @ =0x02033E40
	movs r3, #0xff
_08025190:
	adds r1, r2, r4
	ldrb r0, [r1]
	...
	bx r0
	.align 2, 0
_080251AC: .4byte 0x02039F14
_080251B0: .4byte 0x02039F10
_080251B4: .4byte 0x02033E40

	thumb_func_start sub_080251B8
sub_080251B8: @ 0x080251B8
	push {r4, r5, r6, lr}
	movs r2, #0xcf
	ldr r5, _080251E0 @ =0x02039F14
	ldr r6, _080251E4 @ =0x02039F10
	ldr r4, _080251E8 @ =0x02033E40
	movs r3, #0xff
_080251C4:
	adds r1, r2, r4
	ldrb r0, [r1]
	...
	bx r0
	.align 2, 0
_080251E0: .4byte 0x02039F14
_080251E4: .4byte 0x02039F10
_080251E8: .4byte 0x02033E40

	thumb_func_start sub_080251EC
sub_080251EC: @ 0x080251EC
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	adds r7, r0, #0
	mov r8, r1
	ldr r1, _08025228 @ =0x08C03104
	mov r2, r8
	lsls r0, r2, #2
	adds r0, r0, r1
	ldr r6, [r0]
	ldr r5, _0802522C @ =0x08D613B8
	movs r4, #0x7f
	ands r4, r7
	lsls r4, r4, #3
	adds r0, r5, #6
	...
	b _08025262
	.align 2, 0
_08025228: .4byte 0x08C03104
_0802522C: .4byte 0x08D613B8
_08025230: .4byte 0x08C03100
_08025234:
	cmp r0, #2
	beq _0802524E
	b _08025262
...
_08025262:
	...
	bx r1
	.align 2, 0
_08025274: .4byte 0x02033E40

	thumb_func_start sub_08025278
sub_08025278: @ 0x08025278
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	ldr r0, _080252B0 @ =0x02033E40
	adds r7, r6, r0
	ldrb r1, [r7]
	cmp r1, #0xff
	bne _0802532C
	ldr r5, _080252B4 @ =0x08D613B8
	movs r4, #0x7f
	ands r4, r6
	lsls r4, r4, #3
	adds r0, r5, #4
	...
	b _08025322
	.align 2, 0
_080252B0: .4byte 0x02033E40
_080252B4: .4byte 0x08D613B8
_080252B8: .4byte 0x08C03100
_080252BC:
	cmp r0, #2
	beq _080252FC
	b _08025322
_080252C2:
	ldr r4, _080252DC @ =0x02039F10
	ldr r0, [r4]
	adds r1, r6, #0
	bl sub_08025344
	lsrs r1, r0, #0x1f
	...
	b _08025320
	.align 2, 0
_080252DC: .4byte 0x02039F10
_080252E0:
	ldr r4, _080252F8 @ =0x02039F14
	ldr r0, [r4]
	adds r1, r6, #0
	bl sub_080254B4
	lsrs r1, r0, #0x1f
	...
	b _08025320
	.align 2, 0
_080252F8: .4byte 0x02039F14
_080252FC:
	ldr r4, _08025338 @ =0x02039F14
	ldr r1, [r4]
	movs r0, #0x1e
	ands r0, r1
	cmp r0, #0x1e
...
_08025320:
	str r0, [r4]
_08025322:
	ldr r1, _0802533C @ =0x0203A3CC
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	ldr r0, _08025340 @ =0x02033E40
_0802532C:
	adds r0, r6, r0
	ldrb r0, [r0]
	lsls r0, r0, #1
	...
	bx r1
	.align 2, 0
_08025338: .4byte 0x02039F14
_0802533C: .4byte 0x0203A3CC
_08025340: .4byte 0x02033E40
...
_0802537E:
	...
	bx r1
	.align 2, 0
_080253CC: .4byte 0x08C03114
_080253D0: .4byte 0x08C03100
_080253D4: .4byte 0x02033F10

	thumb_func_start sub_080253D8
sub_080253D8: @ 0x080253D8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0802541E:
	...
	bx r1
	.align 2, 0
_080254A4: .4byte 0x08C03114
_080254A8: .4byte 0x02033F10
_080254AC: .4byte 0x01000010
_080254B0: .4byte 0x08C03100
...
_080254FA:
	...
	bx r1
	.align 2, 0
_08025598: .4byte 0x08C03114
_0802559C: .4byte 0x08C03100
_080255A0: .4byte 0x02033F10

	thumb_func_start sub_080255A4
sub_080255A4: @ 0x080255A4
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_080255EE:
	...
	bx r1
	.align 2, 0
_0802568C: .4byte 0x08C03114
_08025690: .4byte 0x08C03100
...
_080256E2:
	...
	b _0802596A
	.align 2, 0
_08025700: .4byte 0x08C031D4
_08025704: .4byte 0x08D613B8
_08025708:
	cmp r0, #2
	bne _0802570E
	b _08025888
...
_08025BAC:
	...
	thumb_func_start sub_08025BB0
sub_08025BB0: @ 0x08025BB0
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08025CBC: .4byte 0x02039F18
_08025CC0: .4byte 0x00000201
_08025CC4: .4byte 0x0202E3D8
_08025CC8: .4byte 0x08D613B8
_08025CCC: .4byte 0xFFFFC080
_08025CD0: .4byte 0x08D6164A
_08025CD4:
	cmp r0, #0x36
	beq _08025CE2
	b _08025CF0
...
_08025E06:
	...
	mov pc, r0
	.align 2, 0
_08025E10: .4byte 0x02039F18
_08025E14: .4byte 0x0202BBB4
...
_08025E5C:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, _08025E7C @ =0x08BFF788
	ldrh r4, [r6, #8]
	movs r5, #0x80
	lsls r5, r5, #4
	b _08025EE4
	.align 2, 0
_08025E7C: .4byte 0x08BFF788
_08025E80:
	adds r0, r3, #0
	subs r0, #8
	adds r0, r4, r0
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, _08025EA4 @ =0x08BFF770
	ldrh r4, [r6, #8]
	movs r5, #0x80
	lsls r5, r5, #4
	b _08025EE4
	.align 2, 0
_08025EA4: .4byte 0x08BFF770
_08025EA8:
	adds r0, r4, r3
	movs r1, #0x80
	lsls r1, r1, #2
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, _08025EC4 @ =0x08BFF768
	b _08025EDE
	.align 2, 0
_08025EC4: .4byte 0x08BFF768
_08025EC8:
	adds r0, r4, r3
	movs r1, #0x80
	lsls r1, r1, #2
...
_08025FD8: .4byte 0x08BFF760
_08025FDC: .4byte 0x00000C51

	thumb_func_start sub_08025FE0
sub_08025FE0: @ 0x08025FE0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08026118:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r3, _08026134 @ =0x08C033D0
	ldr r5, [sp, #0xc]
	b _08026220
	.align 2, 0
_08026130: .4byte 0x0202BBB4
_08026134: .4byte 0x08C033D0
_08026138:
	movs r1, #0x10
	ldrsb r1, [r4, r1]
	lsls r1, r1, #4
	ldr r2, _08026184 @ =0x0202BBB4
	movs r3, #0xc
	ldrsh r0, [r2, r3]
	subs r3, r1, r0
	movs r0, #0x11
...
_0802616C:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r3, _08026188 @ =0x08C03330
	mov r5, sb
	b _08026220
	.align 2, 0
_08026184: .4byte 0x0202BBB4
_08026188: .4byte 0x08C03330
_0802618C:
	movs r1, #0x10
	ldrsb r1, [r4, r1]
	lsls r1, r1, #4
	ldr r2, _080261D0 @ =0x0202BBB4
	movs r3, #0xc
	ldrsh r0, [r2, r3]
	subs r3, r1, r0
	movs r0, #0x11
	...
	movs r2, #0xff
	ands r1, r2
	ldr r3, _080261D8 @ =0x08C0328C
	ldr r5, [sp, #0x10]
	b _08026220
	.align 2, 0
_080261D0: .4byte 0x0202BBB4
_080261D4: .4byte 0x00000202
_080261D8: .4byte 0x08C0328C
_080261DC:
	movs r1, #0x10
	ldrsb r1, [r4, r1]
	lsls r1, r1, #4
	ldr r2, _08026230 @ =0x0202BBB4
	movs r3, #0xc
	ldrsh r0, [r2, r3]
	subs r3, r1, r0
	movs r0, #0x11
...
_08026304: .4byte 0x08C03400
_08026308: .4byte 0x00000209
_0802630C: .4byte 0x00000107
_08026310: .4byte 0x08BFF760
...
_08026430: .4byte 0x0203A3D0
	...
	thumb_func_start sub_08026434
sub_08026434: @ 0x08026434
	push {r4, lr}
	ldr r2, _08026498 @ =0x0202BBB4
	movs r1, #0x16
	ldrsh r0, [r2, r1]
	ldr r1, _0802649C @ =0x0202E3D8
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r3, #0x14
	...
	b _080264DE
	.align 2, 0
_08026498: .4byte 0x0202BBB4
_0802649C: .4byte 0x0202E3D8
_080264A0: .4byte 0x0203A3D0
_080264A4:
	ldr r2, _080264E4 @ =0x0202BBB4
	ldr r1, [r2, #0x18]
	ldr r0, [r2, #0x14]
	cmp r1, r0
	beq _080264DE
...
_080264DE:
	...
	bx r0
	.align 2, 0
_080264E4: .4byte 0x0202BBB4
_080264E8: .4byte 0x0203A3D0
_080264EC: .4byte 0x0202E3D8

	thumb_func_start sub_080264F0
sub_080264F0: @ 0x080264F0
	push {lr}
	ldr r2, _08026534 @ =0x0202E3D8
	ldr r2, [r2]
	lsls r1, r1, #2
	adds r1, r1, r2
	ldr r1, [r1]
...
sub_08026628: @ 0x08026628
	...
	b _080266C8
	.align 2, 0
_0802667C: .4byte 0x08D613B8
_08026680:
	cmp r0, #2
	beq _080266B4
	b _080266C8
_08026686:
	ldr r3, _08026698 @ =0x08BFF768
	adds r0, r7, r4
	str r0, [sp]
	mov r0, sb
	adds r1, r6, #0
	...
	b _080266C8
	.align 2, 0
_08026698: .4byte 0x08BFF768
_0802669C:
	adds r2, r5, #0
	subs r2, #0x10
	ldr r3, _080266B0 @ =0x08BFF788
	adds r0, r7, r4
	str r0, [sp]
	mov r0, sb
	adds r1, r6, #0
	...
	b _080266C8
	.align 2, 0
_080266B0: .4byte 0x08BFF788
_080266B4:
	adds r1, r6, #0
	subs r1, #8
	adds r2, r5, #0
	subs r2, #0x10
	ldr r3, _080266D8 @ =0x08BFF770
	adds r0, r7, r4
	str r0, [sp]
	mov r0, sb
	bl sub_08006884
...
_08026732:
	...
	lsls r0, r0, #4
	adds r2, r4, r0
	ldr r3, _0802673C @ =0x08BFF768
	b _08026750
	.align 2, 0
_0802673C: .4byte 0x08BFF768
_08026740:
	adds r2, r4, #0
	subs r2, #0x10
	movs r0, #0xff
...
sub_08026794: @ 0x08026794
	...
	b _0802681C
	.align 2, 0
_080267E8: .4byte 0x08C03104
_080267EC: .4byte 0x08D613B8
_080267F0:
	adds r2, r5, #0
	subs r2, #0x10
	ldr r3, _08026804 @ =0x08BFF788
	adds r0, r7, r4
	str r0, [sp]
	mov r0, r8
	adds r1, r6, #0
	...
	b _0802681C
	.align 2, 0
_08026804: .4byte 0x08BFF788
_08026808:
	adds r1, r6, #0
	subs r1, #8
	adds r2, r5, #0
	subs r2, #0x10
	ldr r3, _08026828 @ =0x08BFF770
	adds r0, r7, r4
	str r0, [sp]
	mov r0, r8
	bl sub_08006884
...
sub_08026908: @ 0x08026908
	...
	b _080269DC
	.align 2, 0
_08026958: .4byte 0x08D613B8
_0802695C:
	cmp r0, #2
	beq _080269B8
	b _080269DC
_08026962:
	ldr r3, _08026984 @ =0x08C0340E
	add r4, r8
	str r4, [sp]
	mov r0, sb
	adds r1, r7, #0
	...
	b _080269DC
	.align 2, 0
_08026984: .4byte 0x08C0340E
_08026988: .4byte 0x08C03426
_0802698C:
	adds r5, r6, #0
	subs r5, #0x10
	ldr r3, _080269B0 @ =0x08C03416
	add r4, r8
	str r4, [sp]
	mov r0, sb
	adds r1, r7, #0
	...
	b _080269DC
	.align 2, 0
_080269B0: .4byte 0x08C03416
_080269B4: .4byte 0x08C0342E
_080269B8:
	adds r5, r7, #0
	subs r5, #8
	subs r6, #0x10
	ldr r3, _080269EC @ =0x08C0341E
	add r4, r8
	str r4, [sp]
	mov r0, sb
	adds r1, r5, #0
...
_080269DC:
	...
	bx r0
	.align 2, 0
_080269EC: .4byte 0x08C0341E
_080269F0: .4byte 0x08C03436

	thumb_func_start sub_080269F4
sub_080269F4: @ 0x080269F4
	ldr r1, _080269FC @ =0x02039F18
	movs r0, #0
	str r0, [r1]
	bx lr
	.align 2, 0
